...
function LoginForm() {
  ...
  const [error, setError] = useState<string | null>(
    searchParams.get("error") === "confirmation_failed"
      ? "That confirmation link was invalid or expired. Try logging in, or resend the confirmation email from the verify page."
      : null
  );
    ...
    <main className="relative flex min-h-screen flex-col items-center justify-center p-6">
      ...
      <Card className="w-full max-w-sm shadow-xl shadow-slate-200/50">
        <CardContent className="pt-6">
          <h1 className="mb-6 text-center text-xl font-bold text-slate-900">Welcome back</h1>
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            ...
            <Button type="submit" disabled={loading} className="bg-brand-gradient mt-1 w-full border-0 hover:opacity-90">
